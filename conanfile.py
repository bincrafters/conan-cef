...
class CEFConan(ConanFile):
    ...
    topics = ("cef", "chromium", "chromium-embedded-framework")
    ...
    def system_requirements(self):
        if self.settings.os == "Linux" and tools.os_info.is_linux:
            if tools.os_info.with_apt:
                ...
                packages = ['libpangocairo-1.0-0']
                packages.append('libxcomposite1')
                packages.append('libxrandr2')
                packages.append('libxcursor1')
                packages.append('libatk1.0-0')
                packages.append('libcups2')
                packages.append('libnss3')
                packages.append('libgconf-2-4')
                packages.append('libxss1')
                packages.append('libxtst6')
                packages.append('libgtk2.0-dev')
                packages.append('libgdk-pixbuf2.0-dev')
                packages.append('freeglut3-dev')
